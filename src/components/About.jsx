...
import profilePic from '../assets/ganga.jpg'; 
const socialMedia = [
    {
        id: 1,
    ...
    <>
      <div className="flex  flex-col items-center justify-center mx-auto" id="About">
        <div>
          ...
          <h1 className="font-bold text-4xl:sm text-green-600 text-center" >Hii I am Ganga Prasad Yadav</h1>
          <h2 className="text-white text-center font-medium text-xl:sm  "> Analytical, Self-motivated, Confident</h2>
          <h2 className="text-yellow-600 text-center text-2xl:sm font-semibold">MERN | Full-stack Web Devloper </h2>
